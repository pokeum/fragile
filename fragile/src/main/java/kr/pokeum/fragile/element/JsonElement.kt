...
abstract class JsonElement {
    ...
    open fun setProperty(propertyName: String, value: Any?) {
        throw UnsupportedOperationException(this.javaClass.kotlin.simpleName)
    }

    open fun createObject(propertyName: String): JsonObject {
        throw UnsupportedOperationException(this.javaClass.kotlin.simpleName)
    }

    open fun createArray(propertyName: String): JsonArray {
        throw UnsupportedOperationException(this.javaClass.kotlin.simpleName)
    }
}